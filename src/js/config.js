...
export default {
  ...
  scopes: {
    people: {
      ...
      attributes: process.env.LDAP_PEOPLE_ATTRIBUTES ?
    ...
    groups: {
      ...
      attributes: process.env.LDAP_GROUPS_ATTRIBUTES ?
    ...
    locations: {
      ...
      attributes: process.env.LDAP_LOCATIONS_ATTRIBUTES ?
      ...
      filterForSearch: function (searchText) {
        ...
        return `(|(${this.attributes.name}=*${searchText}*)` +
          `(${this.attributes.city}=*${searchText}*))`;
      }
    }
  }
};
